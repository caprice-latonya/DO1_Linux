...
* ![ubuntu_version](screenshots/Ч1. Вывод версии убунту.png)
...
* ![useradd](screenshots/Ч2.1. Создание пользователя и добавление в группу adm.png)
...
* ![passwd_file](screenshots/Ч2.2. Вывод файла с пользователем в списке.png)
* _**Рисунок 2.2 - Вывод команды cat /etc/passwd**_

* ![set_password](screenshots/Ч2.3. Создание новому пользователю пароля.png)
* _**Рисунок 2.3 - Установка пароля для нового пользователя**_

## Part 3. Настройка сети ОС

* ![hostname_change](screenshots/Ч3.1 Смена имени вм.png)
* _**Рисунок 3.1 - Смена имени ВМ и фиксация изменений**_

* ![timezone](screenshots/Ч3.2 Установка временной зоны и проверка установки.png)
* _**Рисунок 3.2 - Установка временной зоны, соответствующей текущему местоположению**_

* ![interfaces](screenshots/Ч3.3. Вывод сетевых интерфейсов.png)
...
* ![current_ip](screenshots/Ч3.4. Вывод адреса текущего устройства от DHCP-сервера.png)
...
* ![outer_inner_ip](screenshots/Ч3.5. Вывод внешнего и внутреннего IP-адресов шлюзов.png)
...
* ![interfaces_conf_file](screenshots/Ч3.6. Изменение конфигурационного файла etc_network_interfaces.png)
* _**Рисунок 3.6 - Внесение необходимых данных интерфейса enp0s3 в конфигурационный файл /etc/network/interfaces**_

* ![correct_conf](screenshots/Ч3.7. Проверка корректности данных в конф. файле.png)
...
* ![ping](screenshots/Ч3.8. Пинг двух удаленных хостов.png)
...
* ![upgrade_packets](screenshots/Ч4.1. Все пакеты з индекса обновлены.png)
...
* ![change_hostname](screenshots/Ч5.1. Смена названия ВМ через другого пользователя с помощью sudo.png)
...
* ![changed_hostname](screenshots/Ч5.2. Измененное название ВМ после перезагрузки.png)
* _**Рисунок 5.2 - Измененное название ВМ после перезагрузки**_

## Part 6. Установка и настройка службы времени

* ![current_time+command_yes](screenshots/Ч6.1. Текущий часовой пояс и вывод команды из задания.png)
* _**Рисунок 6.1 - Корректный текущий часовой пояс (первая команда) и вывод NTPSynchronized=yes (вторая команда)**_

## Part 7. Установка и использование текстовых редакторов

* ![editors_installation](screenshots/Ч7.1. Установка трех текстовых редакторов.png)
...
* ![vim_contents](screenshots/Ч7.2. Содержимое test_VIM.txt.png)
...
* ![quit_vim](screenshots/Ч7.3. Выход из test_VIM.txt.png)
...
* ![success_quit_vim](screenshots/Ч7.4. Успешный выход из test_VIM.txt.png)
...
* ![joe_contents](screenshots/Ч7.5. Содержимое test_JOE.txt.png)
...
* ![success_quit_joe](screenshots/Ч7.6. Сохранение test_JOE.txt.png)
...
* ![mcedit_contents](screenshots/Ч7.7. Содержимое test_MCEDIT.txt.png)
...
* ![save_window_mcedit](screenshots/Ч7.8. Окно сохранения test_MCEDIT.txt.png)
...
* ![vim_contents_2](screenshots/Ч7.9. Содержимое test_VIM.txt изменение 1.png)
...
* ![quit_vim_no_save](screenshots/Ч7.10. Команда для закрытия test_VIM.txt без сохранения.png)
...
* ![joe_contents_2](screenshots/Ч7.11. Содержмое test_JOE.txt после изменения.png)
...
* ![quit_joe_no_save](screenshots/Ч7.12. Предложение сохранений test_JOE.txt после изменения.png)
...
* ![mcedit_contents_2](screenshots/Ч7.13. Содержимое test_MCEDIT.txt после изменения.png)
...
* ![quit_mcedit_no_save](screenshots/Ч7.14. Окно с предложением сохранения test_MCEDIT.txt перед закрытием.png)
...
* ![vim_find](screenshots/Ч7.15.  Поиск слова в test_VIM.txt.png)
...
* ![vim_switch](screenshots/Ч7.16. Замена слова в test_VIM.txt.png)
...
* ![joe_find](screenshots/Ч7.17. Поиск слова в test_JOE.txt.png)
...
* ![joe_replace_word](screenshots/Ч7.18. Замена слова в test_JOE.txt указание заменяющего слова.png)
...
* ![joe_switch](screenshots/Ч7.19. Замена слова в test_JOE.txt результат.png)
...
* ![mcedit_find_window](screenshots/Ч7.20. Окно для установления параметров поиска вхождений слова.png)
* __*Рисунок 7.20 - Окно для настройки поиска слова в test_MCEDIT.txt*__

* Результат:
* ![mcedit_find](screenshots/Ч7.21. Найденное вхождение слова.png)
...
* ![mcedit_switch_window](screenshots/Ч7.22. Окно с настройкой параметров замены в test_MCEDIT.txt.png)
...
* ![mcedit_switch_approve](screenshots/Ч7.23. Окно подтверждения замены в test_MCEDIT.txt.png)
* __*Рисунок 7.23 - Окно подтверждения замены в test_MCEDIT.txt*__

* После нажатия кнопки Replace получим следующий результат:
* ![mcedit_switch_result](screenshots/Ч7.24. Результат замены в test_MCEDIT.txt.png)
* __*Рисунок 7.24 - Результат замены в test_MCEDIT.txt*__

## Part 8. Установка и базовая настройка сервиса SSHD

* ![sshd_installation](screenshots/Ч8.1. Установка SSHD.png)
* _**Рисунок 8.1 - Установка SSHd**_

* ![autostart](screenshots/Ч8.2. Добавление автостарта SSHd при загрузке системы.png)
...
* ![set_port](screenshots/Ч8.3. Перенастройка SSHd на порт 2022.png)
...
* ![ssh_status](screenshots/Ч8.4. Состояние службы со смененным портом после перезапуска.png)
...
* ![firewall_status](screenshots/Ч8.5. Неактивный брандмауэр.png)
* _**Рисунок 8.5 - Неактивное состояние брандмауэра**_

* Наличие процесса показано на Рисунке 8.6.
* ![proccess](screenshots/Ч8.6. Наличие процесса SSHd.png)
...
* ![socket_off](screenshots/Ч8.7. Отключение сокета ssh.png)
...
* ![sshd_on+command](screenshots/Ч8.8. Включение sshd с прослушиванием IPv4 и команда netstat -tan.png)
...
* ![htop_filter_sshd](screenshots/Ч9.6. Фильтрация htop для sshd.png)
* _**Рисунок 9.6 - Фильтрация htop для процесса sshd с помощью нажатия F4 (Filter) и ввода нужного процесса**_

* ![htop_search_syslog](screenshots/Ч9.7. Поиск в htop процесса syslog.png)
...
* ![htop_add_metrics](screenshots/Ч9.8. Добавление вывода hostname, clock и uptime.png)
* _**Рисунок 9.8 - Добавление метрик в вывод htop (clock отображается под обозначением Time)**_

## Part 10. Использование утилиты fdisk

* ![fdisk](screenshots/Ч10.1. Вывод команды.png)
...
* ![df](screenshots/Ч11.1. Вывод команды.png)
...
* ![df_Th](screenshots/Ч11.2. Вывод втторой команды.png)
...
* ![last_authoriz](screenshots/Ч14.4. Вывод последней авторизации.png)
...
* ![restart_messages_auth](screenshots/Ч14.6. Вывод сообщений о перезапуске в auth.log.png)
* _**Рисунок 14.5 - Сообщения о перезапуске системы в /var/log/auth.log**_

* ![restart_messages_syslog](screenshots/Ч14.5. Строки о перезапуске SHHd.png)
...
* ![crontab_contents](screenshots/Ч15.1. Содержимое файла crontab.png)
* _**Рисунок 15.1 - Содержимое файла crontab**_

* ![syslog_uptime](screenshots/Ч15.2. Сообщения в syslog о выполнении uptime.png)
* _**Рисунок 15.2 - Сообщения в логах /var/log/syslog о выполнении cron-задачи**_

* ![cron_jobs](screenshots/Ч15.3. Вывод текущих задач cron.png)
* _**Рисунок 15.3 - Вывод списка текущих задач cron с помощью команды crontab -l**_

* ![remove_cron_jobs](screenshots/Ч15.4. Удаление всех задач cron и проверка удаления.png)
